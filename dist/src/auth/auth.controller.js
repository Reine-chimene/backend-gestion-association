...
const assign_role_dto_js_1 = require("./dto/assign-role.dto.js");
...
let AuthController = class AuthController {
    ...
    async refresh(refreshToken) {
        if (!refreshToken) {
            throw new common_2.BadRequestException('Refresh token is required in request body');
        }
        return this.authService.refreshToken(refreshToken);
    }
    async assignRole(req, userId, assignRoleDto) {
        return this.authService.assignRole(req.user.sub, userId, assignRoleDto.role, assignRoleDto.motif);
    }
    async getUsersByTenant(req) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, assign_role_dto_js_1.AssignRoleDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "getUsersByTenant", null);
